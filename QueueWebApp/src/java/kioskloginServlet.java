 ...
 */
@WebServlet(urlPatterns = {"/kioskloginServlet"})
public class kioskloginServlet extends HttpServlet {
...
"                <form action=\"kioskgetVIPNumberServlet\">\n" +
...
"            </div>\n" +
"\n" +
"            <div id=\"footervip\" style=\"padding-top:810px;\">\n" +
